...
为当前 DS-160 / 美签项目整理一批可直接进入 RAG 设计与摄取阶段的外部资料，区分：
...
- 抓取摘要：
  ...
  - 适合提炼为结构化 evidence checklist。
- 对 RAG 的价值：
  - 很适合做材料缺口分析与 checklist 类回答。
...
如果目的是先把 RAG 功能落进去，我建议第一版只做两类检索：
...
对当前项目，最值得优先沉淀的不是大量第三方文章，而是：

1. DS-160 官方页和 FAQ
2. USCIS 身份转换 / I-129 / 证据清单
3. 1 到 2 个重点领区页面

这些足以支撑你先做一个“可回答、可引用、可扩展”的最小美签 RAG。
