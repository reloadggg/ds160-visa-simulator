...
export const MOCK_USER_REPORT: UserReport = {
  ...
  interview_status_label: "等待关键证明",
  outcome_label: "需补强关键证据",
  summary: "当前最关键的证明点是资金证明，请优先补强。",
  strengths: ["已完成签证类型识别"],
  risk_points: [],
  risk_level: "medium",
  ...
  allowed_next_actions: [
    {
      ...
      title: "上传关键证明",
      description: "建议先补充资金证明，再继续当前问答主线。",
      cta_text: "上传材料",
      intent: "upload",
    },
    {
      ...
      title: "说明暂缺原因",
      description: "如果暂时不能上传材料，可以先解释资金安排和补件计划。",
      cta_text: "查看建议",
      intent: "details",
    },
  ],
  recommended_improvements: [
    "先说明资金由谁承担，再补充银行流水、资助信或奖学金证明。",
  ],
