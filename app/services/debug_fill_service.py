...
class DebugFillService:
    ...
    def fill_current_gap(self, session_id: str) -> dict:
        record = self.sessions.get(session_id)
        if record is None:
            raise LookupError(f"Session not found: {session_id}")

        target_document_type = self._target_document_type(record)
        profile = self._profile(record)
        fill_document = self._build_document(target_document_type, profile)
    ...
    def _build_document(self, document_type: str, profile: ApplicantProfile) -> DebugFillDocument:
        ...
        school_name = str(profile.education.get("school_name") or "University of Wisconsin-Madison")
            ...
            artifact_json={
                ...
                "metadata": {
                    ...
                    "document_assessment": {
                        ...
                        "confidence": 1.0,
                        "feedback_message": "Debug fill generated this document for local testing.",
                        "relevant": True,
